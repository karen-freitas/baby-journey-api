...
export interface BabyJourneyRepositoryInterface {
  ...
  saveMilestone(id: string, milestone: RecordEntity): Promise<BabyJourneyDocument>;
  saveMemory(id: string, memory: RecordEntity): Promise<BabyJourneyDocument>;
  deleteMilestone(id: string, milestoneId: string): Promise<BabyJourneyDocument>;
...
export const BabyJourneyRepositoryInterface = Symbol('BabyJourneyRepositoryInterface');